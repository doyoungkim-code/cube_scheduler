...
export default function SchedulerView({ onGoHome }: Props) {
  ...
  useEffect(() => {
    return () => {
      window.electronAPI?.toggleCollapse(false)
    }
  }, [])
    ...
    <div className={`app ${collapsed ? 'app--collapsed' : ''}`}>
      <div className="app-layout">
        <div className="app-left">
          <button className="scheduler-home-btn" onClick={onGoHome}>HOME</button>
